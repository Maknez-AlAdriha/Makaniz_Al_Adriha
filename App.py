...
cursor = conn.cursor()
# حقن قالب الـ CSS لتثبيت المحرك أفقياً وتوسيع عرض الواجهة 100% لتوفير النقاء البصري
st.markdown("""
    <style>
...
# ==========================================
# 🔐 الجزء 14 والاخير: محرك الاستيراد التراكمي الفولاذي المطور لضخ معطيات الأنثروبولوجيا والكرامات فوراً
# ==========================================
if st.session_state.sidebar_visible:
    st.sidebar.markdown("---")
